...
*/}}
{{- define "portra-operator.fullname" -}}
...
*/}}
{{- define "portra-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "portra-operator.resourceName" -}}
{{- $fullname := include "portra-operator.fullname" .context }}
{{- $suffix := .suffix }}
